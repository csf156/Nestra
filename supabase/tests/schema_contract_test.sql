...
declare
  v_cols text[][] := array[
    ...
    array['ingest_pendientes','hora','db.js getIngestPendientes (Etapa B, 2026-09-08); si falta, la fila de #revisar se pinta igual pero sin hora — degrada en silencio'],
